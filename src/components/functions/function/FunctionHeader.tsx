      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" >
            <DropdownMenuLabel><p className="text-xs font-medium">John Doe</p>
            <p className="text-[10px] font-light">john@gmail.com</p></DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-xs"><BsGear size={10}/> Settings</DropdownMenuItem>
            <DropdownMenuItem className="text-xs"><MdHelpOutline size={10}/>Help & Support</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-red-600 text-xs">
              <MdOutlineLogout size={10}/>Signout
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
