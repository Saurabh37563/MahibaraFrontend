...
export default function ChatMessage({ message }) {
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div
        className={`relative group max-w-[90%] md:max-w-[80%] p-4 rounded-lg ${
          isUser
      ...
      >
        ...
        {isUser && (
          <div className="absolute -right-10 top-0 w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white">
            U
          </div>
        )}
