...
const faqData = [
  {
    ...
    answer:
      "MAB is a comprehensive auditing tool designed for organizations to monitor, assess, and audit child organizations or subsidiaries. It provides powerful insights, compliance tracking, and standardized auditing procedures to ensure consistent oversight across organizational hierarchies.",
  },
  {
    id: "faq-2",
    question: "How do I set up a new audit for a child organization?",
    answer:
      'To set up a new audit, navigate to the Dashboard and click "New Audit" in the top right corner. Select the child organization from the dropdown menu, choose your audit template or create a custom one, set the audit timeframe, and assign auditors. Once configured, click "Initiate Audit" to begin the process.',
  },
  {
    id: "faq-3",
    question:
      "Can I customize audit templates for different types of organizations?",
    answer:
      'Yes, MAB allows complete customization of audit templates. Go to "Settings" → "Audit Templates" to either modify existing templates or create new ones from scratch. You can tailor questions, compliance requirements, and scoring metrics based on organizational type, industry, or specific compliance needs.',
  },
  {
    id: "faq-4",
    question: "How are permissions managed for auditors vs. administrators?",
    answer:
      'MAB features a robust role-based access control system. Administrators have full access to create audits, manage users, and view all reports. Auditors can only access assigned audits and submit findings. Organization managers can view results for their organization. Custom roles can be configured in "Settings" → "User Management" → "Roles".',
  },
  {
    id: "faq-5",
    question: "How do I export audit reports?",
    answer:
      'To export audit reports, navigate to the "Reports" section, select the completed audit, and click "Export" in the top right corner. You can choose from PDF, Excel, or CSV formats. Custom export templates can be configured to include specific sections or metrics based on your reporting needs.',
  },
  {
    id: "faq-6",
    question: "What compliance frameworks does MAB support?",
    answer:
      "MAB supports major compliance frameworks including ISO 27001, SOC 2, GDPR, HIPAA, and more. Our library of pre-built templates aligns with these frameworks, and you can map custom controls to specific compliance requirements. For custom frameworks, use our template builder to create tailored audit processes.",
  },
];
...
const documentationData = [
  {
    ...
    description:
      "Learn the basics of setting up MAB, creating your first audit, and understanding key features.",
    icon: Book,
  ...
  },
  {
    ...
    title: "User Manual",
    description:
      "Detailed documentation covering all features, functions, and capabilities of the MAB platform.",
    icon: FileText,
  ...
  },
  {
    ...
    description:
      "Solutions to common issues, error messages, and technical problems you might encounter.",
    icon: AlertCircle,
  ...
  },
  {
    ...
    description:
      "Technical references, endpoints, and integration guides for developers and system administrators.",
    icon: FileText,
...
const trainingVideosData = [
  {
    ...
    description:
      "Overview of the platform, navigation, and core features. Perfect for new users.",
    duration: "15 mins",
  },
  {
    id: "training-2",
    ...
    description:
      "Learn how to create comprehensive audit templates tailored to your organization's needs.",
    duration: "25 mins",
  },
  {
    id: "training-3",
    ...
    description:
      "Master the reporting capabilities to extract valuable insights from your audit data.",
    duration: "30 mins",
  },
];
      ...
      <div className="w-full mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Find answers, resources, and support to help you get the most out of
            MAB Auditing Tool
          </p>
        </div>
            ...
            <Card className="border-none shadow-md">
              <CardHeader className="bg-gradient-to-r from-green-950 to-emerald-800 p-4 text-white rounded-t-lg">
                ...
                <CardDescription className="text-emerald-100">
                  Find answers to the most common questions about MAB Auditing
                  Tool
                </CardDescription>
              </CardHeader>
              ...
              <CardFooter className="bg-slate-50 py-4 rounded-b-lg border-t border-slate-100 flex justify-between items-center">
                ...
                <Button
                  variant="outline"
                  className="border-emerald-600 text-emerald-700 hidden md:flex"
                >
              ...
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {documentationData.map((doc) => (
                    <Card
                      key={doc.id}
                      className="border border-slate-200 hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer"
                    >
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg flex items-center text-green-900">
                          <doc.icon className="h-5 w-5 mr-2 text-emerald-600" />{" "}
                          {doc.title}
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                      ...
                      <CardFooter className="border-t border-slate-100 pt-2">
                        <Button
                          variant="ghost"
                          className="text-emerald-700 p-0 flex items-center"
                        >
                          {doc.buttonText}{" "}
              ...
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {trainingVideosData.map((video) => (
                    <Card
                      key={video.id}
                      className="border border-slate-200 hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer group"
                    >
